...
public class Coord implements Comparable<Coord> {
     ...
     */
    public static boolean isValidCoords(Coord coord) {
        boolean ret = false;
    ...
    public static Coord dist(Coord a, Coord b) {
        char col;
        int ligne;

        col = (char) (a.getColonne() - b.getColonne());
        ligne = a.getLigne() - b.getLigne();
