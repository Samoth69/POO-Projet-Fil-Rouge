...
public class TestModel1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("coord valides ('a',7) ? "+ Coord.isValidCoords(c1));		//true
		System.out.println("coord valides ('w',9) ? "+ Coord.isValidCoords(new Coord('w',9)));	//false
		System.out.println("coord valides ('b',11) ? "+ Coord.isValidCoords(new Coord('b',11) ));	//false
