...
public class Controller implements Mediator, BoardGame<Integer>, EventHandler<MouseEvent> {
    ...
    public OutputModelData<Integer> moveCapturePromote(Integer toMovePieceIndex, Integer targetSquareIndex) {
        ...
        OutputModelData<Coord> omd = model.moveCapturePromote(transformIndexToCoord(toMovePieceIndex), transformIndexToCoord(targetSquareIndex));

        outputControllerData = new OutputModelData<>(
                omd.isMoveDone,
        ...
        if (outputControllerData.isMoveDone) {
